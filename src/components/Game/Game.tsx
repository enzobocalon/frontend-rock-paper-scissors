    ...
    <>
      {
        !pick ? (
          <S.Container>
          <S.FirstRow>
            <S.Border borderColor={['hsl(230, 89%, 62%)', 'hsl(230, 89%, 65%)']} onClick={() => handlePick('paper')}>
              <S.Play>
            ...
            <S.Border borderColor={['hsl(39, 89%, 49%)', 'hsl(40, 84%, 53%)']} onClick={() => handlePick('scissors')}>
              <S.Play>
          ...
          <S.SecondRow>
          <S.Border borderColor={['hsl(349, 71%, 52%)', 'hsl(349, 70%, 56%)']} onClick={() => handlePick('rock')}>
              <S.Play>
